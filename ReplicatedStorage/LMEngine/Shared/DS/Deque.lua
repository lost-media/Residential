...
-[Deque] Data Structure
	...
	Methods:
        ...
        Deque:IterRight() () -> any?
            Returns an iterator that iterates over the elements from the right end of the deque

        Deque:IterLeft() () -> any?
            Returns an iterator that iterates over the elements from the left end of the deque
