...
function StructuresUtils.GetAttachmentsThatMatchSnapPoints(structureId1: string, structureId2: string, structure1: Model, structure2: Model) : {{[Attachment]: Attachment}}?
    if (structure1 == nil or structure2 == nil) then
        return;
    end
